...
var IonBody = React.createClass({
  ...
  childContextTypes: {
    ...
    ionKeyboard: PropTypes.object,
    ionSetTransitionDirection: PropTypes.func,
    ionNavDirection: PropTypes.string,
    ionModal: PropTypes.oneOfType([PropTypes.object,PropTypes.bool]),
    ...
    ionPopover: PropTypes.oneOfType([PropTypes.object,PropTypes.bool]),
    ionShowPopover: PropTypes.func,
    ionActionSheet: PropTypes.object,
    ionPopup: PropTypes.object
  },
